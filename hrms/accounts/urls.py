...
from accounts.views import (
    ...
    create_award, list_awards, get_award, update_award, delete_award, mark_attendance_view, attendance_page
)
...
urlpatterns = [
    ...
    path('attendance/', attendance_page, name='attendance_page'),  # main page
]